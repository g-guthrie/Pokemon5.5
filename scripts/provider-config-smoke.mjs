...
async function fakeProviderChoice({provider, model, expectedUrl}) {
  ...
  globalThis.fetch = async (url, options = {}) => {
    ...
    const content = JSON.stringify({
      ...
      setArchetypes: ['Revealed active reads as a generic test set.'],
      unknownInformation: ['Nothing else is revealed in this test board.'],
      ...
      teraAndSwitchCheck: ['No Terastallization or switch is relevant on this test board.'],
      candidateOutcomes: ['The only legal action resolves the turn regardless of response.'],
      decisionCheck: ['No alternate legal action exists.'],
